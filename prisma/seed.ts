  ...
  try {
    ...
    const account1 = await prisma.account.upsert({
      ...
      create: {
        ...
        password:
          '$2b$10$gpXG1rbl8bgNh6YF5cVnTOiSP6/07WjDNyqRgBevMPHG3E/eFlAnu',
        ...
        privateKey:
          'B0BA5757B131747B9D6A5C441D12BF5F77FBA9843E22E1ECA02F1F49BA640419',
        publicKey:
          '04349FF90A5B44941DAFA1E7338794A5509AF4105FCF0BFFED825C430FF5734A0EF3F6CDE590DA8E66483F268D85620B7C5D1195E7487CBA24682581B1178977E4',
        referredBy: null,
      },
    });
    ...
    const account2 = await prisma.account.upsert({
      ...
      create: {
        ...
        password:
          '$2b$10$zZG78RXWFgmfy8EyMnd7lueLVkDLNT2TBpu30ZtMTUIiJjd2q5RbW',
        ...
        privateKey:
          '568E18484EDCF4502C81D1CC21C3B785B99BD3AA0E23B05717FB82DD5204E750',
        publicKey:
          '04748648C581DD8B37EA9E518A9B8345D3B2135929927EBE5C13E928F13BC6E1770C5731C777DE013461A01789215CA81390B23A9370621BEA84592EEA2C1D7EC6',
        referredBy: null,
      },
    });
